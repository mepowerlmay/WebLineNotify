...
using WinLineNotifyTCP.DAL;
using WinLineNotifyTCP.Model;

namespace WinLineNotifyTCP
{
    public partial class FormTCP2PLC : Form
    {
        private LinenotifymsgDAL linenotifymsgDAL { get; set; }
       ...
       HPSocketCSNET4.Extra<ClientInfo> extra = new HPSocketCSNET4.Extra<ClientInfo>();
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (  string.IsNullOrEmpty( cboIP.Text))
                {
                    MessageBox.Show("請選擇IP");
                    return;
                }
       ...
       private  void SetAppState(AppState state)
        ...
        private void SendLineMsg(string msg)
        {
            ...
            model.Statu = "1";
            model.SendTime = DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss");
            model.IsDelete = "0";
